# Module 11: Zoom Live Classes (5 Slugs) - UI Component & Screen Layout Extraction Specification
...
- **Target Module**: `Module 11: Zoom Live Classes (5 Slugs)`
...
- **Authoritative CRUD Reference**: [`references/11_...`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/references/)
...
### Screen 01: `live-meeting` (`media_1789154630455.png`)

- **Image File**: [`media_1789154630455.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789154630455.png)
- **Screen / Slug Name**: `live-meeting`
- **Target Platform Route**: `/super-admin/zoom/live-meeting`
...
### Screen 02: `live-classes` (`media_1789154640676.png`)

- **Image File**: [`media_1789154640676.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789154640676.png)
- **Screen / Slug Name**: `live-classes`
- **Target Platform Route**: `/super-admin/zoom/live-classes`
- **UI Layout Archetype**: **Archetype A: Split Two-Column Master-Detail Layout (Form Left / Table Right)**
...
### Screen 03: `live-classes-report` (`media_1789154651697.png`)

- **Image File**: [`media_1789154651697.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789154651697.png)
- **Screen / Slug Name**: `live-classes-report`
- **Target Platform Route**: `/super-admin/zoom/live-classes-report`
...
### Screen 04: `live-meeting-report-setting` (`media_1789154662759.png`)

- **Image File**: [`media_1789154662759.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789154662759.png)
- **Screen / Slug Name**: `live-meeting-report-setting`
- **Target Platform Route**: `/super-admin/zoom/live-meeting-report-setting`
