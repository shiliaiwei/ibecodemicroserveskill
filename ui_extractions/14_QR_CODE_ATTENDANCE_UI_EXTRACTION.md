# Module 14: QR Code Attendance (2 Slugs) - UI Component & Screen Layout Extraction Specification
...
- **Target Module**: `Module 14: QR Code Attendance (2 Slugs)`
...
- **Authoritative CRUD Reference**: [`references/14_...`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/references/)
...
### Screen 01: `attendance` (`media_1789155113774.png`)

- **Image File**: [`media_1789155113774.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789155113774.png)
- **Screen / Slug Name**: `attendance`
- **Target Platform Route**: `/super-admin/qr-attendance/attendance`
...
### Screen 02: `setting` (`media_1789155127895.png`)

- **Image File**: [`media_1789155127895.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789155127895.png)
- **Screen / Slug Name**: `setting`
- **Target Platform Route**: `/super-admin/qr-attendance/setting`
- **Byte-Level Image Twin**: Identical content hash `4b44367a` shared with `media_1789155176831.png` (multi-take capture).
