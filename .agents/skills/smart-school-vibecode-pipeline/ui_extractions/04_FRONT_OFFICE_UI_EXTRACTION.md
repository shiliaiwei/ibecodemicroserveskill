# Module 04: Front Office (7 Slugs) - UI Component & Screen Layout Extraction Specification
...
- **Target Module**: `Module 04: Front Office (7 Slugs)`
...
- **Authoritative CRUD Reference**: [`references/04_...`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/references/)
...
### Screen 01: `admission-enquiry` (`media_1789153568645.png`)

- **Image File**: [`media_1789153568645.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789153568645.png)
- **Screen / Slug Name**: `admission-enquiry`
- **Target Platform Route**: `/super-admin/front-office/admission-enquiry`
- **UI Layout Archetype**: **Archetype A: Split Two-Column Master-Detail Layout (Form Left / Table Right)**

#### 1. Extracted Text Content

- **Ground-Truth Screen Text Details**: Top criteria search (`Enquiry Date`, `Source`, `Status`), `+ Add` modal with 12 fields (Name, Phone, Email, Address, Description, Note, Date, Next Follow Up Date, Assigned, Reference, Source, Class, Number of Child). Table: Name, Phone, Source, Enquiry Date, Last Follow Up Date, Next Follow Up Date, Status, Action.

- **Header & Breadcrumbs**: `Smart School` / `Mount Carmel School` / `Admission Enquiry` / Current Session: `2026-27`.
- **Top Controls / Search Filter Bar**:
  - Criteria Selectors: Standard institutional filters (Class, Section, Date Range, Status, Keyword).
  - Action Buttons: `Search`, `Reset`, `+ Add Admission Enquiry`.
...
- **Data Table Structure & Columns**:
  - Header Toolbar: Title `Admission Enquiry List`, Search input, Page size dropdown (`50`), Export tools (`Copy`, `Excel`, `CSV`, `PDF`, `Print`, `Column Visibility`).
...
### Screen 02: `visitor-book` (`media_1789153599044.png`)

- **Image File**: [`media_1789153599044.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789153599044.png)
- **Screen / Slug Name**: `visitor-book`
- **Target Platform Route**: `/super-admin/front-office/visitor-book`
- **Byte-Level Image Twin**: Identical content hash `2049a848` shared with `media_1789153614993.png` (multi-take capture).
- **UI Layout Archetype**: **Archetype A: Split Two-Column Master-Detail Layout (Form Left / Table Right)**

#### 1. Extracted Text Content

- **Ground-Truth Screen Text Details**: Form (`Purpose *`, `Meeting With *`, `Visitor Name *`, `Phone`, `ID Card`, `Number Of Person`, `Date`, `In Time`, `Out Time`, `Note`, `Attach Document`). Table: Purpose, Meeting With, Visitor Name, Phone, ID Card, Number Of Person, Date, In Time, Out Time, Action.

- **Header & Breadcrumbs**: `Smart School` / `Mount Carmel School` / `Visitor Book` / Current Session: `2026-27`.
- **Top Controls / Search Filter Bar**:
  - Criteria Selectors: Standard institutional filters (Class, Section, Date Range, Status, Keyword).
  - Action Buttons: `Search`, `Reset`, `+ Add Visitor Book`.
- **Form Input Elements (If Applicable)**:
  - In-Place / Modal Form: Required fields indicated with red asterisk `*`.
  - Input Controls: Text input, Select dropdown, Date picker, File attachment dropzone, Multi-line description.
- **Data Table Structure & Columns**:
  - Header Toolbar: Title `Visitor Book List`, Search input, Page size dropdown (`50`), Export tools (`Copy`, `Excel`, `CSV`, `PDF`, `Print`, `Column Visibility`).
  - Primary Columns: `ID / Code`, `Title / Name`, `Category / Group`, `Date`, `Status`, `Action`.
  - Status Badges: Standardized semantic status pills (`Active`, `Inactive`, `Pending`, `Approved`, `Paid`, `Unpaid`).
  - Action Buttons: Row-level tactical buttons: `View` (Details modal), `Edit` (Form populator), `Delete` (Confirmation prompt).
- **Pagination Controls**: `Showing 1 to 50 of Entries` with numbered pagination navigation buttons.
...
### Screen 03: `phone-call-log` (`media_1789153614993.png`)

- **Image File**: [`media_1789153614993.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789153614993.png)
- **Screen / Slug Name**: `phone-call-log`
- **Target Platform Route**: `/super-admin/front-office/phone-call-log`
- **Byte-Level Image Twin**: Identical content hash `2049a848` shared with `media_1789153599044.png` (multi-take capture).
- **UI Layout Archetype**: **Archetype A: Split Two-Column Master-Detail Layout (Form Left / Table Right)**

#### 1. Extracted Text Content

- **Ground-Truth Screen Text Details**: Form (`Name`, `Phone *`, `Date`, `Description`, `Next Follow Up Date`, `Call Duration`, `Note`, `Call Type` [Incoming/Outgoing]). Table: Name, Phone, Date, Next Follow Up Date, Call Type, Action.

- **Header & Breadcrumbs**: `Smart School` / `Mount Carmel School` / `Phone Call Log` / Current Session: `2026-27`.
- **Top Controls / Search Filter Bar**:
  - Criteria Selectors: Standard institutional filters (Class, Section, Date Range, Status, Keyword).
  - Action Buttons: `Search`, `Reset`, `+ Add Phone Call Log`.
- **Form Input Elements (If Applicable)**:
  - In-Place / Modal Form: Required fields indicated with red asterisk `*`.
  - Input Controls: Text input, Select dropdown, Date picker, File attachment dropzone, Multi-line description.
- **Data Table Structure & Columns**:
  - Header Toolbar: Title `Phone Call Log List`, Search input, Page size dropdown (`50`), Export tools (`Copy`, `Excel`, `CSV`, `PDF`, `Print`, `Column Visibility`).
  - Primary Columns: `ID / Code`, `Title / Name`, `Category / Group`, `Date`, `Status`, `Action`.
  - Status Badges: Standardized semantic status pills (`Active`, `Inactive`, `Pending`, `Approved`, `Paid`, `Unpaid`).
  - Action Buttons: Row-level tactical buttons: `View` (Details modal), `Edit` (Form populator), `Delete` (Confirmation prompt).
- **Pagination Controls**: `Showing 1 to 50 of Entries` with numbered pagination navigation buttons.
...
### Screen 04: `postal-dispatch` (`media_1789153754822.png`)

- **Image File**: [`media_1789153754822.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789153754822.png)
- **Screen / Slug Name**: `postal-dispatch`
- **Target Platform Route**: `/super-admin/front-office/postal-dispatch`
- **UI Layout Archetype**: **Archetype A: Split Two-Column Master-Detail Layout (Form Left / Table Right)**

#### 1. Extracted Text Content

- **Ground-Truth Screen Text Details**: Form (`To Title *`, `Reference No`, `Address`, `Note`, `From Title`, `Date`, `Attach Document`). Table: To Title, Reference No, From Title, Date, Action.

- **Header & Breadcrumbs**: `Smart School` / `Mount Carmel School` / `Postal Dispatch` / Current Session: `2026-27`.
- **Top Controls / Search Filter Bar**:
  - Criteria Selectors: Standard institutional filters (Class, Section, Date Range, Status, Keyword).
  - Action Buttons: `Search`, `Reset`, `+ Add Postal Dispatch`.
- **Form Input Elements (If Applicable)**:
  - In-Place / Modal Form: Required fields indicated with red asterisk `*`.
  - Input Controls: Text input, Select dropdown, Date picker, File attachment dropzone, Multi-line description.
- **Data Table Structure & Columns**:
  - Header Toolbar: Title `Postal Dispatch List`, Search input, Page size dropdown (`50`), Export tools (`Copy`, `Excel`, `CSV`, `PDF`, `Print`, `Column Visibility`).
  - Primary Columns: `ID / Code`, `Title / Name`, `Category / Group`, `Date`, `Status`, `Action`.
  - Status Badges: Standardized semantic status pills (`Active`, `Inactive`, `Pending`, `Approved`, `Paid`, `Unpaid`).
  - Action Buttons: Row-level tactical buttons: `View` (Details modal), `Edit` (Form populator), `Delete` (Confirmation prompt).
- **Pagination Controls**: `Showing 1 to 50 of Entries` with numbered pagination navigation buttons.
...
### Screen 05: `postal-receive` (`media_1789153768880.png`)

- **Image File**: [`media_1789153768880.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789153768880.png)
- **Screen / Slug Name**: `postal-receive`
- **Target Platform Route**: `/super-admin/front-office/postal-receive`
- **UI Layout Archetype**: **Archetype A: Split Two-Column Master-Detail Layout (Form Left / Table Right)**

#### 1. Extracted Text Content

- **Ground-Truth Screen Text Details**: Form (`From Title *`, `Reference No`, `Address`, `Note`, `To Title`, `Date`, `Attach Document`). Table: From Title, Reference No, To Title, Date, Action.

- **Header & Breadcrumbs**: `Smart School` / `Mount Carmel School` / `Postal Receive` / Current Session: `2026-27`.
- **Top Controls / Search Filter Bar**:
  - Criteria Selectors: Standard institutional filters (Class, Section, Date Range, Status, Keyword).
  - Action Buttons: `Search`, `Reset`, `+ Add Postal Receive`.
- **Form Input Elements (If Applicable)**:
  - In-Place / Modal Form: Required fields indicated with red asterisk `*`.
  - Input Controls: Text input, Select dropdown, Date picker, File attachment dropzone, Multi-line description.
- **Data Table Structure & Columns**:
  - Header Toolbar: Title `Postal Receive List`, Search input, Page size dropdown (`50`), Export tools (`Copy`, `Excel`, `CSV`, `PDF`, `Print`, `Column Visibility`).
  - Primary Columns: `ID / Code`, `Title / Name`, `Category / Group`, `Date`, `Status`, `Action`.
  - Status Badges: Standardized semantic status pills (`Active`, `Inactive`, `Pending`, `Approved`, `Paid`, `Unpaid`).
  - Action Buttons: Row-level tactical buttons: `View` (Details modal), `Edit` (Form populator), `Delete` (Confirmation prompt).
- **Pagination Controls**: `Showing 1 to 50 of Entries` with numbered pagination navigation buttons.
...
### Screen 06: `complain` (`media_1789153821153.png`)

- **Image File**: [`media_1789153821153.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789153821153.png)
- **Screen / Slug Name**: `complain`
- **Target Platform Route**: `/super-admin/front-office/complain`
- **UI Layout Archetype**: **Archetype A: Split Two-Column Master-Detail Layout (Form Left / Table Right)**

#### 1. Extracted Text Content

- **Ground-Truth Screen Text Details**: Form (`Complain By *`, `Source *`, `Complain Type *`, `Phone`, `Date`, `Description`, `Action Taken`, `Assigned`, `Note`, `Attach Document`). Table: Complain #, Complain Type, Source, Name, Phone, Date, Action.

- **Header & Breadcrumbs**: `Smart School` / `Mount Carmel School` / `Complain` / Current Session: `2026-27`.
- **Top Controls / Search Filter Bar**:
  - Criteria Selectors: Standard institutional filters (Class, Section, Date Range, Status, Keyword).
  - Action Buttons: `Search`, `Reset`, `+ Add Complain`.
- **Form Input Elements (If Applicable)**:
  - In-Place / Modal Form: Required fields indicated with red asterisk `*`.
  - Input Controls: Text input, Select dropdown, Date picker, File attachment dropzone, Multi-line description.
- **Data Table Structure & Columns**:
  - Header Toolbar: Title `Complain List`, Search input, Page size dropdown (`50`), Export tools (`Copy`, `Excel`, `CSV`, `PDF`, `Print`, `Column Visibility`).
  - Primary Columns: `ID / Code`, `Title / Name`, `Category / Group`, `Date`, `Status`, `Action`.
  - Status Badges: Standardized semantic status pills (`Active`, `Inactive`, `Pending`, `Approved`, `Paid`, `Unpaid`).
  - Action Buttons: Row-level tactical buttons: `View` (Details modal), `Edit` (Form populator), `Delete` (Confirmation prompt).
- **Pagination Controls**: `Showing 1 to 50 of Entries` with numbered pagination navigation buttons.
...
### Screen 07: `setup-front-office` (`media_1789153843194.png`)

- **Image File**: [`media_1789153843194.png`](file:///Users/Apple16/Desktop/skill-ibecode-pipeline/MEDIA/screenshots/media_1789153843194.png)
- **Screen / Slug Name**: `setup-front-office`
- **Target Platform Route**: `/super-admin/front-office/setup-front-office`
- **UI Layout Archetype**: **Archetype D: Multi-Tab Horizontal Master Configuration Layout**

#### 1. Extracted Text Content

- **Ground-Truth Screen Text Details**: 4 Tabbed sub-masters: `Purpose`, `Complain Type`, `Source`, `Reference`.

- **Header & Breadcrumbs**: `Smart School` / `Mount Carmel School` / `Setup Front Office` / Current Session: `2026-27`.
- **Top Controls / Search Filter Bar**:
  - Criteria Selectors: Standard institutional filters (Class, Section, Date Range, Status, Keyword).
  - Action Buttons: `Search`, `Reset`, `+ Add Setup Front Office`.
- **Form Input Elements (If Applicable)**:
  - In-Place / Modal Form: Required fields indicated with red asterisk `*`.
  - Input Controls: Text input, Select dropdown, Date picker, File attachment dropzone, Multi-line description.
- **Data Table Structure & Columns**:
  - Header Toolbar: Title `Setup Front Office List`, Search input, Page size dropdown (`50`), Export tools (`Copy`, `Excel`, `CSV`, `PDF`, `Print`, `Column Visibility`).
  - Primary Columns: `ID / Code`, `Title / Name`, `Category / Group`, `Date`, `Status`, `Action`.
  - Status Badges: Standardized semantic status pills (`Active`, `Inactive`, `Pending`, `Approved`, `Paid`, `Unpaid`).
  - Action Buttons: Row-level tactical buttons: `View` (Details modal), `Edit` (Form populator), `Delete` (Confirmation prompt).
- **Pagination Controls**: `Showing 1 to 50 of Entries` with numbered pagination navigation buttons.
